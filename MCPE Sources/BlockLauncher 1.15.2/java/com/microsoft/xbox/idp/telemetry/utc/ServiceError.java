...
public class ServiceError extends Data<CommonData> {
    ...
    public boolean memberwiseCompare(Object obj) {
        ...
        return memberwiseCompareQuick(serviceError) && memberwiseCompareDeep(serviceError);
    }

    protected boolean memberwiseCompareDeep(ServiceError serviceError) {
        boolean z = (super.memberwiseCompareDeep(serviceError)) && (this.errorName == null || this.errorName.equals(serviceError.errorName));
        z = z && (this.errorText == null || this.errorText.equals(serviceError.errorText));
        z = z && (this.errorCode == null || this.errorCode.equals(serviceError.errorCode));
        return z && (this.pageName == null || this.pageName.equals(serviceError.pageName));
    }

    protected boolean memberwiseCompareQuick(ServiceError serviceError) {
        boolean z;
        if (super.memberwiseCompareQuick(serviceError)) {
            if ((this.errorName == null) == (serviceError.errorName == null)) {
                z = true;
                z = z && (this.errorName == null || this.errorName.length() == serviceError.errorName.length());
                if (z) {
                    if ((this.errorText != null) == (serviceError.errorText != null)) {
                        z = true;
                        z = z && (this.errorText == null || this.errorText.length() == serviceError.errorText.length());
                        if (z) {
                            if ((this.errorCode != null) == (serviceError.errorCode != null)) {
                                z = true;
                                z = z && (this.errorCode == null || this.errorCode.length() == serviceError.errorCode.length());
                                if (z) {
                                    if ((this.pageName != null) == (serviceError.pageName != null)) {
                                        z = true;
                                        return z && (this.pageName == null || this.pageName.length() == serviceError.pageName.length());
                                    }
                                }
                                z = false;
                                if (!z) {
        ...
        if (z) {
            ...
            if (serviceError.errorText != null) {
            }
            if ((this.errorText != null) == (serviceError.errorText != null)) {
                z = true;
                if (z) {
    ...
    public void writeNested(ProtocolWriter protocolWriter, boolean z) throws IOException {
        ...
        if (hasCapability && this.pageName == Schema.pageName_metadata.getDefault_value().getWstring_value()) {
            protocolWriter.writeFieldOmitted(BondDataType.BT_WSTRING, 40, Schema.pageName_metadata);
        } else {
            protocolWriter.writeFieldBegin(BondDataType.BT_WSTRING, 40, Schema.pageName_metadata);
