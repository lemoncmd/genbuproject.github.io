...
class JavaMembers {
    ...
    private static void discoverAccessibleMethods(Class<?> cls, Map<MethodSignature, Method> map, boolean z, boolean z2) {
                ...
                while (superclass != null) {
                    try {
                        ...
                        try {
                            ...
                            Context.reportWarning("Could not discover accessible methods of class " + superclass.getName() + " due to lack of privileges, " + "attemping superclasses/interfaces.");
                        }
                    }
                }
                return;
        ...
        if (superclass2 != null) {
            discoverAccessibleMethods(superclass2, map, z, z2);
        }
    }
                        ...
                        if (Character.isUpperCase(charAt)) {
                            ...
                            if (!hashMap.containsKey(value)) {
                                ...
                                if (obj == null || (z2 && (obj instanceof Member) && Modifier.isPrivate(((Member) obj).getModifiers()))) {
                                    ...
                                    findGetter2 = findGetter != null ? findGetter(isStatic, map4, "is", substring) : findGetter;
                                    str2 = "set".concat(substring);
                                    if (map4.containsKey(str2)) {
                                        obj = map4.get(str2);
                                        if (obj instanceof NativeJavaMethod) {
                                            nativeJavaMethod2 = (NativeJavaMethod) obj;
                                            extractSetMethod = findGetter2 == null ? extractSetMethod(findGetter2.method().getReturnType(), nativeJavaMethod2.methods, isStatic) : extractSetMethod(nativeJavaMethod2.methods, isStatic);
    ...
    void put(Scriptable scriptable, String str, Object obj, Object obj2, boolean z) {
        ...
        Field field2 = field instanceof FieldAndMethods ? ((FieldAndMethods) map.get(str)).field : field;
