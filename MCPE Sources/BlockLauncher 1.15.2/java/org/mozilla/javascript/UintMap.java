...
public class UintMap implements Serializable {
    ...
    private int ensureIndex(int i, boolean z) {
        ...
        if (iArr != null) {
            ...
            if (i3 != EMPTY) {
                i3 = i3 == DELETED ? i2 : EMPTY;
                int i5 = (1 << this.power) + EMPTY;
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) throws IOException {
        ...
        int i = this.keyCount;
        if (i != 0) {
            boolean z2 = this.ivaluesShift != 0 ? true : check;
            if (this.values == null) {
                z = check;
            }
    ...
    public int getExistingInt(int i) {
        ...
        if (findIndex >= 0) {
            return this.ivaluesShift != 0 ? this.keys[findIndex + this.ivaluesShift] : 0;
        } else {
            Kit.codeBug();
            return 0;
        }
    ...
    public int getInt(int i, int i2) {
        ...
        int findIndex = findIndex(i);
        return findIndex >= 0 ? this.ivaluesShift != 0 ? this.keys[findIndex + this.ivaluesShift] : 0 : i2;
    }
    ...
    public boolean has(int i) {
        ...
        return findIndex(i) >= 0 ? true : check;
    }

    public boolean isEmpty() {
        return this.keyCount == 0 ? true : check;
    }
    ...
    public void put(int i, Object obj) {
        ...
        int ensureIndex = ensureIndex(i, check);
        if (this.values == null) {
