...
public class PolicySecurityController extends SecurityController {
    ...
    private static byte[] loadBytecode() {
        ...
        classFileWriter.startMethod("call", "(Lorg/mozilla/javascript/Callable;" + name, (short) 17);
        while (i < 6) {
            classFileWriter.addALoad(i);
            i++;
        }
        classFileWriter.addInvoke(185, "org/mozilla/javascript/Callable", "call", "(" + name);
