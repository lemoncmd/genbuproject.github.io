...
public class ScriptRuntime {
    ...
    public static Locale ROOT_LOCALE = new Locale(BuildConfig.FLAVOR);
    ...
    public static final Object[] emptyArgs = new Object[ENUMERATE_KEYS];
    public static final String[] emptyStrings = new String[ENUMERATE_KEYS];
    ...
    static class NoSuchMethodShim implements Callable {
        ...
        public Object call(Context context, Scriptable scriptable, Scriptable scriptable2, Object[] objArr) {
            Object[] objArr2 = new Object[ScriptRuntime.ENUMERATE_ARRAY];
            objArr2[ScriptRuntime.ENUMERATE_KEYS] = this.methodName;
            objArr2[ScriptRuntime.ENUMERATE_VALUES] = ScriptRuntime.newArrayLiteral(objArr, null, context, scriptable);
            return this.noSuchMethodMethod.call(context, scriptable, scriptable2, objArr2);
        }
    }
    ...
    public static Object add(Object obj, Object obj2, Context context) {
        ...
        addValues = obj instanceof Scriptable ? ((Scriptable) obj).getDefaultValue(null) : obj;
        Object defaultValue = obj2 instanceof Scriptable ? ((Scriptable) obj2).getDefaultValue(null) : obj2;
    ...
    public static void addInstructionCount(Context context, int i) {
        ...
        if (context.instructionCount > context.instructionThreshold) {
            ...
            context.instructionCount = ENUMERATE_KEYS;
        }
    }
    ...
    public static Object applyOrCall(boolean z, Context context, Scriptable scriptable, Scriptable scriptable2, Object[] objArr) {
        ...
        if (length != 0) {
            scriptable3 = context.hasFeature(15) ? toObjectOrNull(context, objArr[ENUMERATE_KEYS], scriptable) : objArr[ENUMERATE_KEYS] == Undefined.instance ? Undefined.SCRIPTABLE_UNDEFINED : toObjectOrNull(context, objArr[ENUMERATE_KEYS], scriptable);
        }
        Scriptable topCallScope = (scriptable3 == null && context.hasFeature(15)) ? getTopCallScope(context) : scriptable3;
        if (z) {
            applyArguments = length <= ENUMERATE_VALUES ? emptyArgs : getApplyArguments(context, objArr[ENUMERATE_VALUES]);
        } else if (length <= ENUMERATE_VALUES) {
            applyArguments = emptyArgs;
        } else {
            applyArguments = new Object[(length - 1)];
            System.arraycopy(objArr, ENUMERATE_VALUES, applyArguments, ENUMERATE_KEYS, length - 1);
        }
    ...
    static void checkDeprecated(Context context, String str) {
        ...
        if (languageVersion >= Token.SETPROP_OP || languageVersion == 0) {
    ...
    public static EcmaError constructError(String str, String str2) {
        int[] iArr = new int[ENUMERATE_VALUES];
        return constructError(str, str2, Context.getSourcePositionFromStack(iArr), iArr[ENUMERATE_KEYS], null, ENUMERATE_KEYS);
    }

    public static EcmaError constructError(String str, String str2, int i) {
        int[] iArr = new int[ENUMERATE_VALUES];
        String sourcePositionFromStack = Context.getSourcePositionFromStack(iArr);
        if (iArr[ENUMERATE_KEYS] != 0) {
            iArr[ENUMERATE_KEYS] = iArr[ENUMERATE_KEYS] + i;
        }
        return constructError(str, str2, sourcePositionFromStack, iArr[ENUMERATE_KEYS], null, ENUMERATE_KEYS);
    }
    ...
    static String defaultObjectToSource(Context context, Scriptable scriptable, Scriptable scriptable2, Object[] objArr) {
        ...
        if (context.iterating == null) {
            ...
            obj = ENUMERATE_VALUES;
            z = false;
        } else {
            z = context.iterating.has(scriptable2);
            obj = ENUMERATE_KEYS;
        }
        StringBuilder stringBuilder = new StringBuilder(Token.RESERVED);
        if (obj != null) {
        ...
        if (!z) {
            ...
            for (int i = ENUMERATE_KEYS; i < ids.length; i += ENUMERATE_VALUES) {
                Object obj2 = ids[i];
    ...
    public static boolean deleteObjectElem(Scriptable scriptable, Object obj, Context context) {
        ...
        if (toStringIdOrIndex == null) {
            ...
            return !scriptable.has(toStringIdOrIndex, scriptable);
        }
    }
    ...
    private static Object doScriptableIncrDecr(Scriptable scriptable, String str, Scriptable scriptable2, Object obj, int i) {
        double doubleValue;
        Object obj2;
        Object obj3 = (i & ENUMERATE_ARRAY) != 0 ? ENUMERATE_VALUES : ENUMERATE_KEYS;
        ...
        Object wrapNumber2 = wrapNumber((i & ENUMERATE_VALUES) == 0 ? doubleValue + 1.0d : doubleValue - 1.0d);
        scriptable.put(str, scriptable2, wrapNumber2);
        return obj3 != null ? obj2 : wrapNumber2;
    }
    ...
    public static Object elemIncrDecr(Object obj, Object obj2, Context context, Scriptable scriptable, int i) {
        ...
        Object obj4 = (i & ENUMERATE_ARRAY) != 0 ? ENUMERATE_VALUES : ENUMERATE_KEYS;
        ...
        Number wrapNumber2 = wrapNumber((i & ENUMERATE_VALUES) == 0 ? doubleValue + 1.0d : doubleValue - 1.0d);
        setObjectElem(obj, obj2, wrapNumber2, context, scriptable);
        return obj4 != null ? obj3 : wrapNumber2;
    }
    ...
    public static Scriptable enterWith(Object obj, Context context, Scriptable scriptable) {
        Scriptable toObjectOrNull = toObjectOrNull(context, obj, scriptable);
        if (toObjectOrNull != null) {
            return toObjectOrNull instanceof XMLObject ? ((XMLObject) toObjectOrNull).enterWith(scriptable) : new NativeWith(scriptable, toObjectOrNull);
        } else {
    ...
    private static void enumChangeObject(IdEnumeration idEnumeration) {
        ...
        if (!(idEnumeration.obj == null || idEnumeration.ids == null)) {
            ...
            for (int i = ENUMERATE_KEYS; i != length; i += ENUMERATE_VALUES) {
                idEnumeration.used.intern(objArr2[i]);
            }
        }
        idEnumeration.ids = objArr;
        idEnumeration.index = ENUMERATE_KEYS;
    }
    ...
    public static Object enumId(Object obj, Context context) {
        ...
        switch (idEnumeration.enumType) {
            case ENUMERATE_KEYS /*0*/:
            case ENUMERATE_KEYS_NO_ITERATOR /*3*/:
                return idEnumeration.currentId;
            case ENUMERATE_VALUES /*1*/:
            case ENUMERATE_VALUES_NO_ITERATOR /*4*/:
                return enumValue(obj, context);
            case ENUMERATE_ARRAY /*2*/:
            case ENUMERATE_ARRAY_NO_ITERATOR /*5*/:
                Object[] objArr = new Object[ENUMERATE_ARRAY];
                objArr[ENUMERATE_KEYS] = idEnumeration.currentId;
                objArr[ENUMERATE_VALUES] = enumValue(obj, context);
                return context.newArray(ScriptableObject.getTopLevelScope(idEnumeration.obj), objArr);
            default:
                throw Kit.codeBug();
        }
    }
    ...
    public static Object enumInit(Object obj, Context context, Scriptable scriptable, int i) {
        ...
        if (i == ENUMERATE_VALUES_IN_ORDER) {
            idEnumeration.enumType = i;
            idEnumeration.iterator = null;
            return enumInitInOrder(context, idEnumeration);
        } else if (idEnumeration.obj == null) {
            return idEnumeration;
        } else {
            idEnumeration.enumType = i;
            idEnumeration.iterator = null;
            if (!(i == ENUMERATE_KEYS_NO_ITERATOR || i == ENUMERATE_VALUES_NO_ITERATOR || i == ENUMERATE_ARRAY_NO_ITERATOR)) {
    ...
    public static Object enumInit(Object obj, Context context, boolean z) {
        return enumInit(obj, context, z ? ENUMERATE_VALUES : ENUMERATE_KEYS);
    }

    private static Object enumInitInOrder(Context context, IdEnumeration idEnumeration) {
        if (idEnumeration.obj == null || !ScriptableObject.hasProperty(idEnumeration.obj, NativeSymbol.ITERATOR_PROPERTY)) {
            throw typeError1("msg.not.iterable", toString(idEnumeration.obj));
        }
        Object property = ScriptableObject.getProperty(idEnumeration.obj, NativeSymbol.ITERATOR_PROPERTY);
        if (property instanceof Callable) {
            property = ((Callable) property).call(context, idEnumeration.obj.getParentScope(), idEnumeration.obj, new Object[ENUMERATE_KEYS]);
            if (property instanceof Scriptable) {
                idEnumeration.iterator = (Scriptable) property;
                return idEnumeration;
            }
            throw typeError1("msg.not.iterable", toString(idEnumeration.obj));
        }
    ...
    public static Boolean enumNext(Object obj) {
        ...
        if (idEnumeration.iterator == null) {
            while (idEnumeration.obj != null) {
                if (idEnumeration.index == idEnumeration.ids.length) {
                    ...
                    idEnumeration.index = i + ENUMERATE_VALUES;
                    obj2 = objArr[i];
        ...
        } else if (idEnumeration.enumType == ENUMERATE_VALUES_IN_ORDER) {
            return enumNextInOrder(idEnumeration);
        } else {
            obj2 = ScriptableObject.getProperty(idEnumeration.iterator, ES6Iterator.NEXT_METHOD);
            if (!(obj2 instanceof Callable)) {
                return Boolean.FALSE;
            }
            try {
                idEnumeration.currentId = ((Callable) obj2).call(Context.getContext(), idEnumeration.iterator.getParentScope(), idEnumeration.iterator, emptyArgs);
                return Boolean.TRUE;
    ...
    private static Boolean enumNextInOrder(IdEnumeration idEnumeration) {
        ...
        if (property instanceof Callable) {
            ...
            Scriptable toObject = toObject(context, parentScope, callable.call(context, parentScope, idEnumeration.iterator, emptyArgs));
            Object property2 = ScriptableObject.getProperty(toObject, ES6Iterator.DONE_PROPERTY);
            if (property2 != ScriptableObject.NOT_FOUND && toBoolean(property2)) {
                return Boolean.FALSE;
            }
            idEnumeration.currentId = ScriptableObject.getProperty(toObject, ES6Iterator.VALUE_PROPERTY);
            return Boolean.TRUE;
        }
    ...
    public static Object enumValue(Object obj, Context context) {
        IdEnumeration idEnumeration = (IdEnumeration) obj;
        String toStringIdOrIndex = toStringIdOrIndex(context, idEnumeration.currentId);
        if (toStringIdOrIndex != null) {
            return idEnumeration.obj.get(toStringIdOrIndex, idEnumeration.obj);
        }
    ...
    public static boolean eq(Object obj, Object obj2) {
        ...
        if (obj == null || obj == Undefined.instance) {
            ...
            return equivalentValues != Scriptable.NOT_FOUND ? ((Boolean) equivalentValues).booleanValue() : false;
            ...
            if (obj instanceof Boolean) {
                ...
                if (obj2 instanceof Boolean) {
                    return booleanValue == ((Boolean) obj2).booleanValue() ? ENUMERATE_VALUES : false;
                }
                if (obj2 instanceof ScriptableObject) {
                    equivalentValues = ((ScriptableObject) obj2).equivalentValues(obj);
                ...
                return equivalentValues == unwrap || (isPrimitive(equivalentValues) && isPrimitive(unwrap) && eq(equivalentValues, unwrap));
            } else if (!(obj2 instanceof Boolean)) {
                return obj2 instanceof Number ? eqNumber(((Number) obj2).doubleValue(), obj) : obj2 instanceof CharSequence ? eqString((CharSequence) obj2, obj) : false;
            } else {
                if (obj instanceof ScriptableObject) {
                    equivalentValues = ((ScriptableObject) obj).equivalentValues(obj2);
                    if (equivalentValues != Scriptable.NOT_FOUND) {
    ...
    static boolean eqNumber(double d, Object obj) {
        ...
        while (obj2 != null && obj2 != Undefined.instance) {
            if (obj2 instanceof Number) {
                return d == ((Number) obj2).doubleValue() ? true : ENUMERATE_KEYS;
    ...
    private static boolean eqString(CharSequence charSequence, Object obj) {
        ...
        while (obj2 != null && obj2 != Undefined.instance) {
            if (obj2 instanceof CharSequence) {
                ...
                boolean z = (charSequence.length() == charSequence2.length() && charSequence.toString().equals(charSequence2.toString())) ? true : ENUMERATE_KEYS;
                return z;
            } else if (obj2 instanceof Number) {
                return toNumber(charSequence.toString()) == ((Number) obj2).doubleValue();
            } else {
                if (obj2 instanceof Boolean) {
                    return toNumber(charSequence.toString()) == (((Boolean) obj2).booleanValue() ? 1.0d : 0.0d);
                } else if (obj2 instanceof Scriptable) {
                    if (obj2 instanceof ScriptableObject) {
        ...
        for (int i = ENUMERATE_KEYS; i != length; i += ENUMERATE_VALUES) {
            ...
            if (' ' > charAt || charAt > '~' || charAt == c || charAt == '\\') {
                ...
                if (stringBuilder == null) {
                    stringBuilder2 = new StringBuilder(length + ENUMERATE_KEYS_NO_ITERATOR);
                ...
                if (i2 >= 0) {
                    ...
                    if (charAt < '\u0100') {
                        ...
                        i2 = ENUMERATE_VALUES_NO_ITERATOR;
                    }
                    for (int i3 = (i2 - 1) * ENUMERATE_VALUES_NO_ITERATOR; i3 >= 0; i3 -= 4) {
                        i2 = (charAt >> i3) & 15;
    ...
    public static Object evalSpecial(Context context, Scriptable scriptable, Object obj, Object[] objArr, String str, int i) {
        if (objArr.length < ENUMERATE_VALUES) {
            return Undefined.instance;
        }
        Object obj2 = objArr[ENUMERATE_KEYS];
        if (obj2 instanceof CharSequence) {
            if (str == null) {
                int[] iArr = new int[ENUMERATE_VALUES];
                str = Context.getSourcePositionFromStack(iArr);
                if (str != null) {
                    i = iArr[ENUMERATE_KEYS];
                } else {
            ...
            Script compileString = context.compileString(obj2.toString(), createInterpreter, forEval, makeUrlForGeneratedScript, ENUMERATE_VALUES, null);
    ...
    public static Object[] getArrayElements(Scriptable scriptable) {
        ...
        for (int i2 = ENUMERATE_KEYS; i2 < i; i2 += ENUMERATE_VALUES) {
    ...
    public static ScriptableObject getGlobal(Context context) {
        ...
        if (classOrNull != null) {
            try {
                Class[] clsArr = new Class[ENUMERATE_VALUES];
                clsArr[ENUMERATE_KEYS] = ContextClass;
                Constructor constructor = classOrNull.getConstructor(clsArr);
                Object[] objArr = new Object[ENUMERATE_VALUES];
                objArr[ENUMERATE_KEYS] = context;
                return (ScriptableObject) constructor.newInstance(objArr);
    ...
    public static String getMessage2(String str, Object obj, Object obj2) {
        Object[] objArr = new Object[ENUMERATE_ARRAY];
        objArr[ENUMERATE_KEYS] = obj;
        objArr[ENUMERATE_VALUES] = obj2;
        return getMessage(str, objArr);
    }

    public static String getMessage3(String str, Object obj, Object obj2, Object obj3) {
        Object[] objArr = new Object[ENUMERATE_KEYS_NO_ITERATOR];
        objArr[ENUMERATE_KEYS] = obj;
        objArr[ENUMERATE_VALUES] = obj2;
        objArr[ENUMERATE_ARRAY] = obj3;
        return getMessage(str, objArr);
    }

    public static String getMessage4(String str, Object obj, Object obj2, Object obj3, Object obj4) {
        Object[] objArr = new Object[ENUMERATE_VALUES_NO_ITERATOR];
        objArr[ENUMERATE_KEYS] = obj;
        objArr[ENUMERATE_VALUES] = obj2;
        objArr[ENUMERATE_ARRAY] = obj3;
        objArr[ENUMERATE_KEYS_NO_ITERATOR] = obj4;
        return getMessage(str, objArr);
    }
    ...
    public static Object getObjectElem(Scriptable scriptable, Object obj, Context context) {
        ...
        if (scriptable instanceof XMLObject) {
            ...
            String toStringIdOrIndex = toStringIdOrIndex(context, obj);
            obj2 = toStringIdOrIndex == null ? ScriptableObject.getProperty(scriptable, lastIndexResult(context)) : ScriptableObject.getProperty(scriptable, toStringIdOrIndex);
        }
    ...
    public static Object getObjectIndex(Object obj, double d, Context context, Scriptable scriptable) {
        ...
        int i = (int) d;
        return ((double) i) == d ? getObjectIndex(toObjectOrNull, i, context) : getObjectProp(toObjectOrNull, toString(d), context);
    }
    ...
    private static Callable getPropFunctionAndThisHelper(Object obj, String str, Context context, Scriptable scriptable) {
        ...
        if (!(property2 instanceof Callable)) {
            ...
            if (property instanceof Callable) {
                property = new NoSuchMethodShim((Callable) property, str);
                if (property instanceof Callable) {
    ...
    static String[] getTopPackageNames() {
        if ("Dalvik".equals(System.getProperty("java.vm.name"))) {
            return new String[]{"java", "javax", "org", "com", "edu", "net", AddAccountActivity.PlatformName};
        }
        String[] strArr = new String[ENUMERATE_VALUES_IN_ORDER];
        strArr[ENUMERATE_KEYS] = "java";
        strArr[ENUMERATE_VALUES] = "javax";
        strArr[ENUMERATE_ARRAY] = "org";
        strArr[ENUMERATE_KEYS_NO_ITERATOR] = "com";
        strArr[ENUMERATE_VALUES_NO_ITERATOR] = "edu";
        strArr[ENUMERATE_ARRAY_NO_ITERATOR] = "net";
        return strArr;
    }
    ...
    public static boolean hasObjectElem(Scriptable scriptable, Object obj, Context context) {
        String toStringIdOrIndex = toStringIdOrIndex(context, obj);
        return toStringIdOrIndex == null ? ScriptableObject.hasProperty(scriptable, lastIndexResult(context)) : ScriptableObject.hasProperty(scriptable, toStringIdOrIndex);
    }
        ...
        if (i == ENUMERATE_VALUES) {
            ...
            if (functionName != null && functionName.length() != 0) {
                if (z) {
                    ...
                    ScriptableObject.defineProperty(scriptable, functionName, nativeFunction, ENUMERATE_VALUES_NO_ITERATOR);
                }
            }
        } else if (i == ENUMERATE_KEYS_NO_ITERATOR) {
            functionName = nativeFunction.getFunctionName();
            if (functionName != null && functionName.length() != 0) {
    ...
    public static ScriptableObject initSafeStandardObjects(Context context, ScriptableObject scriptableObject, boolean z) {
        ScriptableObject nativeObject = scriptableObject == null ? new NativeObject() : scriptableObject;
        ...
        boolean z2 = (!context.hasFeature(ENUMERATE_VALUES_IN_ORDER) || context.getE4xImplementationFactory() == null) ? ENUMERATE_KEYS : true;
        ...
        if (z2) {
            ...
            lazilyLoadedCtor = new LazilyLoadedCtor(nativeObject, "XML", implementationClassName, z, true);
        ...
        if ((context.getLanguageVersion() >= Context.VERSION_1_8 && context.hasFeature(14)) || context.getLanguageVersion() >= Context.VERSION_ES6) {
            lazilyLoadedCtor = new LazilyLoadedCtor(nativeObject, "ArrayBuffer", "org.mozilla.javascript.typedarrays.NativeArrayBuffer", z, true);
            ...
            lazilyLoadedCtor = new LazilyLoadedCtor(nativeObject, "DataView", "org.mozilla.javascript.typedarrays.NativeDataView", z, true);
        }
        if (context.getLanguageVersion() >= Context.VERSION_ES6) {
            lazilyLoadedCtor = new LazilyLoadedCtor(nativeObject, NativeSymbol.CLASS_NAME, NativeSymbol.class.getName(), z, true);
        }
            ...
            while (true) {
                ...
                if (paramAndVarCount != 0) {
                    ...
                    if (ScriptableObject.hasProperty(scriptable2, paramOrVarName)) {
                        ...
                        ScriptableObject.defineProperty(scriptable3, paramOrVarName, Undefined.instance, ENUMERATE_VALUES_NO_ITERATOR);
                    }
                    paramAndVarCount = i;
                } else {
                    return;
    ...
    public static ScriptableObject initStandardObjects(Context context, ScriptableObject scriptableObject, boolean z) {
        ...
        String[] topPackageNames = getTopPackageNames();
        int length = topPackageNames.length;
        for (int i = ENUMERATE_KEYS; i < length; i += ENUMERATE_VALUES) {
            lazilyLoadedCtor = new LazilyLoadedCtor(initSafeStandardObjects, topPackageNames[i], "org.mozilla.javascript.NativeJavaTopPackage", z, true);
        }
    ...
    public static boolean instanceOf(Object obj, Object obj2, Context context) {
        if (obj2 instanceof Scriptable) {
            return !(obj instanceof Scriptable) ? false : ((Scriptable) obj2).hasInstance((Scriptable) obj);
        } else {
    ...
    public static boolean isJSLineTerminator(int i) {
        return (57296 & i) != 0 ? false : i == 10 || i == 13 || i == 8232 || i == 8233;
    }
    ...
    static boolean isValidIdentifierName(String str, Context context, boolean z) {
        boolean z2 = true;
        int length = str.length();
        if (length == 0 || !Character.isJavaIdentifierStart(str.charAt(ENUMERATE_KEYS))) {
            return false;
        }
        for (int i = ENUMERATE_VALUES; i != length; i += ENUMERATE_VALUES) {
            if (!Character.isJavaIdentifierPart(str.charAt(i))) {
                return false;
            }
        }
        if (TokenStream.isKeyword(str, context.getLanguageVersion(), z)) {
            z2 = false;
        }
        return z2;
    }
    ...
    public static Scriptable newArrayLiteral(Object[] objArr, int[] iArr, Context context, Scriptable scriptable) {
        int i = ENUMERATE_KEYS;
        int length = objArr.length;
        int length2 = iArr != null ? iArr.length : ENUMERATE_KEYS;
        int i2 = length + length2;
        int i3;
        int i4;
        if (i2 <= ENUMERATE_VALUES || length2 * ENUMERATE_ARRAY >= i2) {
            Scriptable newArray = context.newArray(scriptable, i2);
            i3 = ENUMERATE_KEYS;
            i4 = ENUMERATE_KEYS;
            while (i3 != i2) {
                if (i4 == length2 || iArr[i4] != i3) {
                    newArray.put(i3, newArray, objArr[i]);
                    i += ENUMERATE_VALUES;
                } else {
                    i4 += ENUMERATE_VALUES;
                }
    ...
    public static Scriptable newCatchScope(Throwable th, Scriptable scriptable, String str, Context context, Scriptable scriptable2) {
        ...
        if (th instanceof JavaScriptException) {
            ...
            if (sourceName == null) {
                sourceName = BuildConfig.FLAVOR;
            }
            int lineNumber = rhinoException.lineNumber();
            Object[] objArr2;
            if (lineNumber > 0) {
                objArr2 = new Object[ENUMERATE_KEYS_NO_ITERATOR];
                objArr2[ENUMERATE_KEYS] = errorMessage;
                objArr2[ENUMERATE_VALUES] = sourceName;
                objArr2[ENUMERATE_ARRAY] = Integer.valueOf(lineNumber);
                objArr = objArr2;
            } else {
                objArr2 = new Object[ENUMERATE_ARRAY];
                objArr2[ENUMERATE_KEYS] = errorMessage;
                objArr2[ENUMERATE_VALUES] = sourceName;
                objArr = objArr2;
            }
            ...
            if (obj2 != null && isVisible(context, obj2)) {
                ScriptableObject.defineProperty(value, "javaException", context.getWrapFactory().wrap(context, scriptable2, obj2, null), 7);
            }
            if (isVisible(context, rhinoException)) {
                ScriptableObject.defineProperty(value, "rhinoException", context.getWrapFactory().wrap(context, scriptable2, rhinoException, null), 7);
            }
            obj = ENUMERATE_VALUES;
        }
        Scriptable nativeObject = new NativeObject();
        nativeObject.defineProperty(str, value, (int) ENUMERATE_VALUES_NO_ITERATOR);
        if (isVisible(context, th)) {
            nativeObject.defineProperty("__exception__", Context.javaToJS(th, scriptable2), (int) ENUMERATE_VALUES_IN_ORDER);
        }
        if (obj != null) {
    ...
    public static Scriptable newObjectLiteral(Object[] objArr, Object[] objArr2, int[] iArr, Context context, Scriptable scriptable) {
        ...
        while (i != length) {
            Object obj = objArr[i];
            int i2 = iArr == null ? ENUMERATE_KEYS : iArr[i];
            Object obj2 = objArr2[i];
            if (!(obj instanceof String)) {
                newObject.put(((Integer) obj).intValue(), newObject, obj2);
            } else if (i2 != 0) {
                ((ScriptableObject) newObject).setGetterOrSetter((String) obj, ENUMERATE_KEYS, (Callable) obj2, i2 == ENUMERATE_VALUES);
    ...
    public static RuntimeException notFunctionError(Object obj, Object obj2) {
        Object obj3 = obj2 == null ? "null" : obj2.toString();
    ...
    public static RuntimeException notFunctionError(Object obj, Object obj2, String str) {
        ...
        if (obj instanceof NativeFunction) {
            int indexOf = scriptRuntime.indexOf(Token.VAR, scriptRuntime.indexOf(41));
            if (indexOf > -1) {
                scriptRuntime = scriptRuntime.substring(ENUMERATE_KEYS, indexOf + ENUMERATE_VALUES) + "...}";
            }
        }
    ...
    public static String numberToString(double d, int i) {
        if (i < ENUMERATE_ARRAY || i > 36) {
            ...
            DToA.JS_dtostr(stringBuilder, ENUMERATE_KEYS, ENUMERATE_KEYS, d);
            return stringBuilder.toString();
        }
    }
    ...
    public static Object refIncrDecr(Ref ref, Context context, Scriptable scriptable, int i) {
        ...
        return obj3 != null ? obj : wrapNumber2;
    }
    ...
    public static Object searchDefaultNamespace(Context context) {
        ...
        return obj == Scriptable.NOT_FOUND ? null : obj;
    }
    ...
    public static Object setDefaultNamespace(Object obj, Context context) {
        ...
        if (scriptable.has(DEFAULT_NS_TAG, scriptable)) {
            ...
            ScriptableObject.defineProperty(scriptable, DEFAULT_NS_TAG, toDefaultXmlNamespace, ENUMERATE_VALUES_IN_ORDER);
        }
        return Undefined.instance;
    }
    ...
    public static Object setObjectIndex(Object obj, double d, Object obj2, Context context, Scriptable scriptable) {
        ...
        int i = (int) d;
        return ((double) i) == d ? setObjectIndex(toObjectOrNull, i, obj2, context) : setObjectProp(toObjectOrNull, toString(d), obj2, context);
    }
    ...
    public static boolean shallowEq(Object obj, Object obj2) {
        if (obj == obj2) {
            ...
            return (obj == Undefined.instance && obj2 == Undefined.SCRIPTABLE_UNDEFINED) ? true : obj == Undefined.SCRIPTABLE_UNDEFINED && obj2 == Undefined.instance;
        } else {
            if (obj instanceof Number) {
                if (obj2 instanceof Number) {
    ...
    public static long testUint32String(String str) {
        long j = 0;
        int length = str.length();
        if (ENUMERATE_VALUES > length || length > 10) {
            return -1;
        }
        int charAt = str.charAt(ENUMERATE_KEYS) - 48;
        if (charAt == 0) {
            if (length != ENUMERATE_VALUES) {
                j = -1;
            }
            return j;
        } else if (ENUMERATE_VALUES > charAt || charAt > 9) {
            return -1;
        } else {
            long j2 = (long) charAt;
            int i = ENUMERATE_VALUES;
            while (i != length) {
    ...
    public static JavaScriptException throwCustomError(Context context, Scriptable scriptable, String str, String str2) {
        int[] iArr = new int[ENUMERATE_VALUES];
        iArr[ENUMERATE_KEYS] = ENUMERATE_KEYS;
        String sourcePositionFromStack = Context.getSourcePositionFromStack(iArr);
        Object[] objArr = new Object[ENUMERATE_KEYS_NO_ITERATOR];
        objArr[ENUMERATE_KEYS] = str2;
        objArr[ENUMERATE_VALUES] = sourcePositionFromStack;
        objArr[ENUMERATE_ARRAY] = Integer.valueOf(iArr[ENUMERATE_KEYS]);
        return new JavaScriptException(context.newObject(scriptable, str, objArr), sourcePositionFromStack, iArr[ENUMERATE_KEYS]);
    }
    ...
    public static JavaScriptException throwError(Context context, Scriptable scriptable, String str) {
        ...
        iArr[ENUMERATE_KEYS] = ENUMERATE_KEYS;
        String sourcePositionFromStack = Context.getSourcePositionFromStack(iArr);
        Builtins builtins = Builtins.Error;
        Object[] objArr = new Object[ENUMERATE_KEYS_NO_ITERATOR];
        objArr[ENUMERATE_KEYS] = str;
        objArr[ENUMERATE_VALUES] = sourcePositionFromStack;
        objArr[ENUMERATE_ARRAY] = Integer.valueOf(iArr[ENUMERATE_KEYS]);
        return new JavaScriptException(newBuiltinObject(context, scriptable, builtins, objArr), sourcePositionFromStack, iArr[ENUMERATE_KEYS]);
    }
    ...
    public static boolean toBoolean(Object obj) {
        ...
        while (!(obj2 instanceof Boolean)) {
            ...
            if (obj2 instanceof CharSequence) {
                return ((CharSequence) obj2).length() != 0 ? true : ENUMERATE_KEYS;
            } else if (obj2 instanceof Number) {
    ...
    public static int toInt32(Object[] objArr, int i) {
        return i < objArr.length ? toInt32(objArr[i]) : ENUMERATE_KEYS;
    }

    public static double toInteger(double d) {
        return d != d ? 0.0d : (d == 0.0d || d == Double.POSITIVE_INFINITY || d == Double.NEGATIVE_INFINITY) ? d : d > 0.0d ? Math.floor(d) : Math.ceil(d);
    }
    ...
    public static Scriptable toIterator(Context context, Scriptable scriptable, Scriptable scriptable2, boolean z) {
        ...
        if (property instanceof Callable) {
            Callable callable = (Callable) property;
            Object[] objArr = new Object[ENUMERATE_VALUES];
            objArr[ENUMERATE_KEYS] = z ? Boolean.TRUE : Boolean.FALSE;
    ...
    public static double toNumber(String str) {
        ...
        while (i != length) {
            ...
            if (isStrWhiteSpaceChar(charAt)) {
                ...
                char charAt2;
                if (charAt == '0') {
                    if (i + ENUMERATE_ARRAY < length) {
                        charAt2 = str.charAt(i + ENUMERATE_VALUES);
                        if (charAt2 == 'x' || charAt2 == 'X') {
                            return stringToNumber(str, i + ENUMERATE_ARRAY, 16);
                        }
                    }
                } else if ((charAt == '+' || charAt == '-') && i + ENUMERATE_KEYS_NO_ITERATOR < length && str.charAt(i + ENUMERATE_VALUES) == '0') {
                    charAt2 = str.charAt(i + ENUMERATE_ARRAY);
                    if (charAt2 == 'x' || charAt2 == 'X') {
                        double stringToNumber = stringToNumber(str, i + ENUMERATE_KEYS_NO_ITERATOR, 16);
                        return charAt == '-' ? -stringToNumber : stringToNumber;
                    }
                }
                length--;
                while (true) {
                ...
                if (charAt2 == 'y') {
                    ...
                    return (i + 7 == length && str.regionMatches(i, "Infinity", ENUMERATE_KEYS, 8)) ? charAt == '-' ? Double.NEGATIVE_INFINITY : Double.POSITIVE_INFINITY : NaN;
                } else {
                    String substring = str.substring(i, length + ENUMERATE_VALUES);
    ...
    public static Scriptable toObjectOrNull(Context context, Object obj) {
        return obj instanceof Scriptable ? (Scriptable) obj : (obj == null || obj == Undefined.instance) ? null : toObject(context, getTopCallScope(context), obj);
    }

    public static Scriptable toObjectOrNull(Context context, Object obj, Scriptable scriptable) {
        return obj instanceof Scriptable ? (Scriptable) obj : (obj == null || obj == Undefined.instance) ? null : toObject(context, scriptable, obj);
    }
    ...
    public static String toString(Object obj) {
        ...
        while (scriptable != null) {
            if (scriptable == Undefined.instance || scriptable == Undefined.SCRIPTABLE_UNDEFINED) {
                return "undefined";
            }
            if (scriptable instanceof String) {
                return (String) scriptable;
            }
            if (scriptable instanceof CharSequence) {
                return scriptable.toString();
            }
            if (scriptable instanceof Number) {
                return numberToString(((Number) scriptable).doubleValue(), 10);
            }
            if (!(scriptable instanceof Scriptable)) {
                return scriptable.toString();
            }
            scriptable = scriptable.getDefaultValue(StringClass);
            if (scriptable instanceof Scriptable) {
                throw errorWithClassName("msg.primitive.expected", scriptable);
            }
        }
        return "null";
    }
    ...
    public static BaseFunction typeErrorThrower(Context context) {
        if (context.typeErrorThrower == null) {
            BaseFunction anonymousClass1 = new BaseFunction() {
                ...
                public int getLength() {
                    return ScriptRuntime.ENUMERATE_KEYS;
                }
            };
            setFunctionProtoAndParent(anonymousClass1, context.topCallScope);
    ...
    static String uneval(Context context, Scriptable scriptable, Object obj) {
        ...
        if (obj instanceof CharSequence) {
            ...
            StringBuilder stringBuilder = new StringBuilder(escapeString.length() + ENUMERATE_ARRAY);
            stringBuilder.append('\"');
    ...
    public static Scriptable wrapException(Throwable th, Scriptable scriptable, Context context) {
        ...
        Object[] objArr;
        if (th instanceof EcmaError) {
            rhinoException = (EcmaError) th;
            name = rhinoException.getName();
            errorMessage = rhinoException.getErrorMessage();
            obj = null;
            obj2 = name;
        } else if (th instanceof WrappedException) {
            ...
            r4 = "JavaException";
            Throwable th2 = wrappedException2;
        ...
        name = rhinoException.sourceName();
        if (name == null) {
        ...
        if (obj != null && isVisible(context, obj)) {
            ScriptableObject.defineProperty(newObject, "javaException", context.getWrapFactory().wrap(context, scriptable, obj, null), 7);
        }
        if (isVisible(context, rhinoException)) {
