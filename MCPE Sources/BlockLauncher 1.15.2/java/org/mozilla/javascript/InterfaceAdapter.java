    ...
    Object invokeImpl(Context context, Object obj, Scriptable scriptable, Object obj2, Method method, Object[] objArr) {
        ...
        if (obj instanceof Callable) {
            ...
            if (property == ScriptableObject.NOT_FOUND) {
                ...
                return returnType != Void.TYPE ? Context.jsToJava(null, returnType) : null;
        ...
        property = callable.call(context, scriptable, wrapFactory.wrapAsJavaObject(context, scriptable, obj2, null), objArr);
        Class returnType2 = method.getReturnType();
        return returnType2 == Void.TYPE ? null : Context.jsToJava(property, returnType2);
    }
}
