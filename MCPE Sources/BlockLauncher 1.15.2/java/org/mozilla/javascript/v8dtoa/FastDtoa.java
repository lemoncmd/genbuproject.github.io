...
public class FastDtoa {
    static final /* synthetic */ boolean $assertionsDisabled = (!FastDtoa.class.desiredAssertionStatus() ? true : $assertionsDisabled);
    ...
    static long biggestPowerTen(int i, int i2) {
        ...
        switch (i2) {
            ...
            case kFastDtoaMaximalLength /*17*/:
            case Token.LSH /*18*/:
            case Token.RSH /*19*/:
                if (kTen5 <= i) {
                    i4 = kTen5;
    ...
    static boolean roundWeed(FastDtoaBuilder fastDtoaBuilder, long j, long j2, long j3, long j4, long j5) {
        ...
        return (j3 >= j7 || j2 - j3 < j4 || (j3 + j4 >= j7 && j7 - j3 <= (j3 + j4) - j7)) ? (2 * j5 > j3 || j3 > j2 - (4 * j5)) ? $assertionsDisabled : true : $assertionsDisabled;
    }
