...
public final class LazilyLoadedCtor implements Serializable {
    ...
    LazilyLoadedCtor(ScriptableObject scriptableObject, String str, String str2, boolean z, boolean z2) {
        ...
        scriptableObject.addLazilyInitializedValue(str, STATE_BEFORE_INIT, this, STATE_WITH_VALUE);
    }

    private Object buildValue() {
        return this.privileged ? AccessController.doPrivileged(new PrivilegedAction<Object>() {
            public Object run() {
    ...
    Object getValue() {
        if (this.state == STATE_WITH_VALUE) {
