...
public class javascript extends Extension {
    ...
    public boolean memberwiseCompare(Object obj) {
        ...
        javascript Microsoft_Telemetry_Extensions_javascript = (javascript) obj;
        return memberwiseCompareQuick(Microsoft_Telemetry_Extensions_javascript) && memberwiseCompareDeep(Microsoft_Telemetry_Extensions_javascript);
    }

    protected boolean memberwiseCompareDeep(javascript Microsoft_Telemetry_Extensions_javascript) {
        return (super.memberwiseCompareDeep(Microsoft_Telemetry_Extensions_javascript)) && (this.libVer == null || this.libVer.equals(Microsoft_Telemetry_Extensions_javascript.libVer));
    }

    protected boolean memberwiseCompareQuick(javascript Microsoft_Telemetry_Extensions_javascript) {
        boolean z;
        if (super.memberwiseCompareQuick(Microsoft_Telemetry_Extensions_javascript)) {
            if ((this.libVer == null) == (Microsoft_Telemetry_Extensions_javascript.libVer == null)) {
                z = true;
                return z && (this.libVer == null || this.libVer.length() == Microsoft_Telemetry_Extensions_javascript.libVer.length());
            }
        }
        z = false;
        if (!z) {
