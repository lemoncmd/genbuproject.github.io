...
public class android extends Extension {
    ...
    public boolean memberwiseCompare(Object obj) {
        ...
        android Microsoft_Telemetry_Extensions_android = (android) obj;
        return memberwiseCompareQuick(Microsoft_Telemetry_Extensions_android) && memberwiseCompareDeep(Microsoft_Telemetry_Extensions_android);
    }

    protected boolean memberwiseCompareDeep(android Microsoft_Telemetry_Extensions_android) {
        return (super.memberwiseCompareDeep(Microsoft_Telemetry_Extensions_android)) && (this.libVer == null || this.libVer.equals(Microsoft_Telemetry_Extensions_android.libVer));
    }

    protected boolean memberwiseCompareQuick(android Microsoft_Telemetry_Extensions_android) {
        boolean z;
        if (super.memberwiseCompareQuick(Microsoft_Telemetry_Extensions_android)) {
            if ((this.libVer == null) == (Microsoft_Telemetry_Extensions_android.libVer == null)) {
                z = true;
                return z && (this.libVer == null || this.libVer.length() == Microsoft_Telemetry_Extensions_android.libVer.length());
            }
        }
        z = false;
        if (!z) {
